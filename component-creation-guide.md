...
### 3. Implement
Once your definition is approved the implementation can be built out. See the [developer section](#for-developers) below for more information on this process.
