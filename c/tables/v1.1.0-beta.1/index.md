...
blocks:
  ...
  - type: two column
    ...
    contents:
      ...
      - type: wide image
        src: ./assets/sortable.table.positions.png
        caption: Illustration of the icon positioning for various header alignments.
      - type: narrow video
        src: ./assets/animations.mov
        caption: The animations for sorting a centered column and when alternating between ascending and descending order.
  ...
  - type: two column
    ...
    contents:
      - type: wide image
        src: ./assets/selectable.table.png
