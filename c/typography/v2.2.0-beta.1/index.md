...
blocks:
  ...
  - type: two column
    text: |
      ### Variants
      There are six different types of UI Text, *Basic*, *Small*, *Large*, *Bold*, *Small Bold*, and *Large Bold*:
  ...
  - type: two column
    text: |
      ### Section UI Headings
      There are seven different types of section UI Headings: *Small*, *Small Bold*, *Basic*, *Bold*, *Light*, *Large*, and *Light Large*.
    contents:
      - type: wide image
    ...
    features:
      ...
      - Light Section UI Heading
      - Large Section UI Heading
      - Light Large Section UI Heading
...
changelog:
  - version: 2.2.0-beta.1
    changes: |
      - ADDED: Large Bold UI Text style
      - ADDED: Light and Large Light variants to the Section UI Headings
  - version: 2.1.1
    changes: |
      - ADDED: Feature links
  - version: 2.1.0
