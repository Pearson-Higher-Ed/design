...
<html lang="en">
<head>
    <title>Code coverage report for src/StaticAlert/StaticAlert.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/StaticAlert</a> StaticAlert.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    const infoCheck = type === 'Information' ? <span class="branch-0 cbranch-no" title="branch not covered" >'info':</span>'';
    const inlineCheck = inline ? <span class="branch-0 cbranch-no" title="branch not covered" >'-inline':</span>'';
    const disableCheck = disable ? <span class="branch-0 cbranch-no" title="branch not covered" >'disabled':</span> null;
&nbsp;
    return (
      &lt;div&gt;
        {this.state.isOpen &amp;&amp;
