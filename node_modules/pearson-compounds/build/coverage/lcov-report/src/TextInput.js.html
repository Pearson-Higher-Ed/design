...
<html lang="en">
<head>
    <title>Code coverage report for src/TextInput.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> TextInput.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        &lt;input
          ...
          onFocus          = {<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.setState({labelStyleTmp:labelFocusStyle})}</span>
          onBlur           = {<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >this.setState({labelStyleTmp:labelStyle})}</span>
...
&nbsp;
  switch (inputState) {
    case 'error':
      ...
      inputStyle      = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-textInput--input_error' </span>: 'pe-textInput--basic_error';
      spanStyle       = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-inputError_underline' </span>  : '';
      butttonStyle    = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-textInput__showButton--error' </span> : 'pe-textInput__showButton-basic'
      labelFocusStyle = 'pe-textLabelInput__label--label_error';
      break;
    case 'disabled':
      labelStyle      = 'pe-textLabelInput__label';
      inputStyle      = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-textInput' </span>: 'pe-textInput--basic';
      spanStyle       = '';
      butttonStyle    = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-textInput__showButton--disabled' </span>: 'pe-textInput__showButton-basic--disabled';
      break;
    case 'readOnly':
      labelStyle      = 'pe-textLabelInput__label';
    ...
    default:
      ...
      butttonStyle    = fancy ? <span class="branch-0 cbranch-no" title="branch not covered" >'pe-textInput__showButton' </span>: 'pe-textInput__showButton-basic';
