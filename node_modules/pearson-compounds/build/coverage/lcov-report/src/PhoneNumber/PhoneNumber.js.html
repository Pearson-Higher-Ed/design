...
<html lang="en">
<head>
    <title>Code coverage report for src/PhoneNumber/PhoneNumber.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/PhoneNumber</a> PhoneNumber.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >  re</span>nder() {
    const { country, placeholder, onChange, value, onKeyDown, disabled,
            ...
            infoMessage, errorMessage } = <span class="cstat-no" title="statement not covered" >this.props;</span>
&nbsp;
    const errorLabel = <span class="cstat-no" title="statement not covered" >errorMessage ? '--label_error' :'';</span>
    const errorInput = <span class="cstat-no" title="statement not covered" >errorMessage ? 'react-phone-number-input__phone--error' : inputClassName;</span>
&nbsp;
