...
![Application Header - Medium Profile Menu]({{ site.baseurl }}/img/application-header/4-medium-menu-open.png)

* 'All Courses' link provides a secondary method of returning home
* 'About REVEL' can be injected here as well

#### Desktop help menu
![Application Header - Medium Help Menu]({{ site.baseurl }}/img/application-header/4-medium-help-open.png)
...
![Application Header - Small]({{ site.baseurl }}/img/application-header/5-small-menu-open.png)
...
#### Open menu on Console
![Application Header - Extra Small Console Menu]({{ site.baseurl }}/img/application-header/6-xsmall-menu-console.png)

* This will include a list of courses (shown here with two courses)

#### Open menu on REVEL
![Application Header - Extra Small REVEL Menu]({{ site.baseurl }}/img/application-header/6-xsmall-menu-revel.png)
...
#### Open help on REVEL
![Application Header - Extra Small REVEL Help]({{ site.baseurl }}/img/application-header/6-xsmall-help-revel.png)

* On REVEL, help may open a dropdown
* In Console, the help option activates the side drawer

#### Signed out and anonymous states
![Application Header - Extra Small Signed Out]({{ site.baseurl }}/img/application-header/6-xsmall-signedout-default.png)

![Application Header - Extra Small Help Only]({{ site.baseurl }}/img/application-header/6-xsmall-anon-helponly.png)

![Application Header - Extra Small Always Learning]({{ site.baseurl }}/img/application-header/6-xsmall-anon-always.png)
...
#### Signed Out Header
![Application Header - Signed Out]({{ site.baseurl }}/img/application-header/7-desktop-signedout.png)

#### Anonymous Header with Help
![Application Header - Anonymous Header with Help]({{ site.baseurl }}/img/application-header/7-desktop-anon-help.png)

#### Anonymous Header
![Application Header - Anonymous Header]({{ site.baseurl }}/img/application-header/7-desktop-anon.png)

### Desktop menu
![Application Header - Desktop Menu Redline]({{ site.baseurl }}/img/application-header/7-desktop-menu-redline.png)
...
![Application Header - Deprecated Help Dropdown]({{ site.baseurl }}/img/application-header/4-medium-help-open.png)

### Mobile Header
![Application Header - Mobile Redline]({{ site.baseurl }}/img/application-header/8-mobile-redline.png)
...
#### Signed Out Header
![Application Header - Signed Out]({{ site.baseurl }}/img/application-header/6-xsmall-signedout-default.png)

#### Anonymous Header with Help
![Application Header - Anonymous Header with Help]({{ site.baseurl }}/img/application-header/6-xsmall-anon-helponly.png)

#### Anonymous Header
![Application Header - Anonymous Header]({{ site.baseurl }}/img/application-header/6-xsmall-anon-always.png)

### Mobile Menu
![Application Header - Mobile Menu Redline]({{ site.baseurl }}/img/application-header/8-mobile-menu-redline.png)
...
#### Desktop Menu Light
![Application Header - Desktop Menu Light]({{ site.baseurl }}/img/application-header/9-desktop-menu-light.png)
...
![Application Header - Deprecated Help Dropdown]({{ site.baseurl }}/img/application-header/9-desktop-help-light.png)

#### Mobile Header Light
![Application Header - Mobile Light]({{ site.baseurl }}/img/application-header/10-mobile-light.png)
...
![Application Header - Mobile Menu Light]({{ site.baseurl }}/img/application-header/10-mobile-deprecated-menu-light.png)
